...
class __TwigTemplate_a04b258c83fda425a2840f2668d19055 extends Template
{
    private $source;
    private $macros = [];
...
\t\tc-0.1-0.1-0.1-0.2-0.1-0.3l0,0V9.3c0-0.2,0-0.3,0.1-0.5c0-0.1,0.1-0.2,0.2-0.3C11.4,8.2,11.7,7.9,12,7.6z\"/>
    ...
    {
        return new Source("", "@webprofiler/Icon/drupal-10.svg", "/var/www/html/curso_drupal/web/modules/contrib/webprofiler/templates/Icon/drupal-10.svg");
    }
